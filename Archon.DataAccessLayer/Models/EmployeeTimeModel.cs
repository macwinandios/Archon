...
namespace Archon.DataAccessLayer.Models
{
    public class EmployeeTimeModel : IEmployeeTimeModel
    {
        ...
        public TimeSpan UpdatedClockInTime { get; set; }
        public TimeSpan UpdatedClockOutTime { get; set; }
        ...
        public float TotalWagesEarnedForDaysChosen { get; set; }
        ...
        public ObservableCollection<IEmployeeTimeModel> HoursAndPayCollection { get; set; }
